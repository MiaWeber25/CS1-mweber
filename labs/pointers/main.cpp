/*
  Lab 6: Pointers, enum type, and namespace Lab
...
int main(int argc, char* argv[]) {
  char input;
  big_int *num1; // a pointer that points to unsigned int --> big_int data type
...
do {
  ...
  switch (oper) {
    case ADD:
      ...
      //store the date by dereferencing Pointers
      cin >> *num1 >> *num2;
    ...
    case MULTIPLY:
      cout << "Enter two whole numbers seperated by space: ";
      //store the data by deferencing Pointers
      //cin.ignore(1000,'\n');
      cin >> *num1 >> *num2;
      //passing pointers to findSum FUNCTION
