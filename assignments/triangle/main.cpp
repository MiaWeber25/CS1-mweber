/* 
    ...
    Useful resource for nan(Not a Number): https://stackoverflow.com/questions/23521834/c-basics-if-statement-testing 
...
float perimeter(float len1, float len2, float len3) {
    ...
    cout << "The perimeter of your triangle is: " << result << endl; //print the perimeter 
    return (0);
}
...
float area(float len1, float len2, float len3) {
    ...
    cout << "The area of your triangle is: " << result << endl; //print the area
     
    //if else statement to notify user if triangle is correct
    if (result == 0 | result == nan("")) { //check if area = 0 or if area = non-real number (neg. sqrt)
